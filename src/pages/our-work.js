...
const OurWork = () => (
  <Layout>
    <SEO
      title="Our Work"
      description="We partner with our customers to design, implement and deliver software projects. Mutual trust and significant transparency are a must in all we do."
    />
